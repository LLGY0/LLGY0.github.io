---
title: 博客构建
published: 2026-04-20    # 发布日期
updated: 2026-04-20       # 更新日期（可选）
description: 记录博客构建关键流程和代码     # 显示在列表页的摘要
cover: "./cover/C1.png"    # 文章封面图（可选）
tags: [Blog]      # 标签
category: Study   # 分类
draft: false             # 是否为草稿
---
...
# 1.0 过去使用的博客架构
## 1.1 Jekyll
Jekyll软件介绍：http://www.noobyard.com/article/p-nwnqarhl-gs.html
Jekyll托管到GitHub：https://www.cnblogs.com/Eaglery/p/5126279.html
```yaml
